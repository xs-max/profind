...
$url = $_SERVER['PHP_SELF'];
        ...
        $pos3 = strrpos($url, "message_admin.php");
...
<?php 
                    if (isset($_SESSION['user_is_logged_in'])) {
                        $firstname =   $_SESSION['user_data']['fullname'];
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-xl-2 col-md-4 sidebar bg-secondary fixed-top">
                        <a href="" class="navbar-brand text-white d-block mx-auto text-center py-3 mb-4 buttom-border">Service DashBoard</a>
                        <div class="buttom-border pb-3 ml-auto">
                           <a href="profile.php?service=<?php echo $id ; ?>"> <?php echo $image ?></a>
                        ...
                        <ul class="navbar-nav flex-column mt-4 ">
                            ...
                            <li class="nav-item">
                                <a href="profile.php?service=<?php echo $id ; ?>" class="nav-link text-white p-2 mb-4 <?php echo $classname2 ?>">
                                    <i class="fas fa-user text-light fa-lg mr-3"></i>Profile
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="message_admin.php?service=<?php echo $id ?>" class="nav-link text-white p-2 mb-4 <?php echo $classname3 ?>">
                                    <i class="fas fa-envelope text-light fa-lg mr-3"></i>Message Admin
                                </a>
                        </ul>
                    </div>
                    <!-- end of sidebar -->
